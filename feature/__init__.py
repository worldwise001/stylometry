...
def extract_features(text):
    features = simple.get_text_stats(text)
    features.update(lexical.get_symbol_dist(text))
    return features


def extract_ngram_features(text):
    features = ngram.get_byte_ngrams(text)
    features.update(ngram.get_word_ngrams(text))
    return features
...
if __name__ == '__main__':
    ...
    pprint.pprint(extract_ngram_features(text))
